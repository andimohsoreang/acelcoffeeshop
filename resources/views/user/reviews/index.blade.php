<x-layouts.app>
    ...
    <div class="bg-slate-50 min-h-screen pb-24 md:pb-16 flex flex-col">
        ...
        <div class="relative overflow-hidden bg-slate-900 pt-16 pb-20 md:pt-24 md:pb-28">
            ...
            <div class="absolute -top-40 -right-40 w-[500px] h-[500px] bg-amber-500 rounded-full blur-[100px] opacity-20"></div>
            <div class="absolute -bottom-40 -left-40 w-[400px] h-[400px] bg-amber-400 rounded-full blur-[100px] opacity-20"></div>
            ...
            <div class="relative z-10 max-w-5xl lg:max-w-7xl mx-auto px-6 lg:px-10 text-center">
                <h1 class="text-3xl md:text-5xl lg:text-6xl font-black text-white tracking-tight leading-tight mb-4">
                    Apa <span class="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-200">Kata Mereka?</span>
                </h1>
                    ...
                    @foreach($reviews as $review)
                        <div class="break-inside-avoid bg-white rounded-3xl p-6 md:p-8 shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-slate-100 hover:shadow-[0_10px_40px_rgb(0,0,0,0.06)] hover:-translate-y-1 transition-all duration-300 group">
                            ...
                            <div class="flex items-center gap-4 mb-5">
                                <div class="w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-400 to-amber-500 flex items-center justify-center text-white font-black text-lg shadow-md flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                                ...
                                <div class="bg-slate-50 border border-slate-100 px-2 py-1.5 rounded-xl flex gap-0.5" title="{{ $review->rating }} out of 5">
                                    @for($i = 1; $i <= 5; $i++)
                                        <svg class="w-3.5 h-3.5 {{ $i <= $review->rating ? 'text-amber-400' : 'text-slate-200' }}" fill="currentColor" viewBox="0 0 20 20">
