...
<div class="md:hidden fixed bottom-0 w-full bg-white border-t border-slate-100 pb-safe z-30 isolate transition-transform duration-300">
    <div class="flex justify-around items-end h-16 px-2 pb-2">
        ...
        {{-- Link Home --}}
        <a href="{{ route('home') }}" aria-label="Beranda" class="flex flex-col items-center justify-center w-16 h-12 gap-1 rounded-2xl transition-colors {{ request()->routeIs('home') ? 'text-brand-primary' : 'text-brand-muted hover:text-brand-dark' }}">
            <div class="relative {{ request()->routeIs('home') ? 'bg-brand-secondary' : '' }} p-1.5 rounded-xl transition-all">
        ...
        {{-- Link Menu / Katalog --}}
        <a href="{{ route('menu.index') }}" aria-label="Menu" class="flex flex-col items-center justify-center w-16 h-12 gap-1 rounded-2xl transition-colors {{ request()->routeIs('menu.*') ? 'text-brand-primary' : 'text-brand-muted hover:text-brand-dark' }}">
            <div class="relative {{ request()->routeIs('menu.*') ? 'bg-brand-secondary' : '' }} p-1.5 rounded-xl transition-all">
        ...
        <div class="relative -top-3">
            ...
            <a href="{{ route('cart.index') }}" aria-label="Keranjang Belanja" class="flex items-center justify-center w-14 h-14 bg-brand-primary text-white rounded-full shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all">
        ...
        {{-- Riwayat (Pesanan) --}}
        <a href="{{ route('order.index') }}" aria-label="Pesanan Saya" class="flex flex-col items-center justify-center w-16 h-12 gap-1 rounded-2xl transition-colors {{ request()->routeIs('order.*') ? 'text-brand-primary' : 'text-brand-muted hover:text-brand-dark' }}">
            <div class="relative {{ request()->routeIs('order.*') ? 'bg-brand-secondary' : '' }} p-1.5 rounded-xl transition-all">
        ...
        {{-- Reviews --}}
        <a href="{{ route('reviews.index') }}" aria-label="Ulasan" class="flex flex-col items-center justify-center w-16 h-12 gap-1 rounded-2xl transition-colors {{ request()->routeIs('reviews.*') ? 'text-brand-primary' : 'text-brand-muted hover:text-brand-dark' }}">
            <div class="relative {{ request()->routeIs('reviews.*') ? 'bg-brand-secondary' : '' }} p-1.5 rounded-xl transition-all">
